...
In total, we performed measurements of 22~shielding combinations: One measurement with no shielding, measurements for three thicknesses each of concrete, steel, and polyethylene, and measurements for four thicknesses of concrete in position~X with scattering shielding added each to position~Z, position~Y, and both positions~Z and Y.

The exact thicknesses of materials tested in this laboratory are tabulated in Tables~\ref{} and \ref{}
\begin{table}
