...
Most notably, since the rate of gamma emissions at a specific energy can be predicted from isotope properties and a source's overall activity, the number of counts a detector registers near that energy can be used to estimate a \emph{detection efficiency} of the spectrum detector at that energy
